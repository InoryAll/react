...
export default class App extends React.Component {
    ...
    render() {
        ...
        // tabs ,tabCount
        //tabs格式：{field:"xxx","showTotal":true,defaultShow:"", tags:[{"fieldValue":"","displayValue":"全部"},{"fieldValue":"男","displayValue":"男","showTotal":true},{"fieldValue":"女","displayValue":"女"}]}
        const tabPanelCount = 3;
        const tabPanelContent=(
            <div style={{paddingTop:10,fontSize:18,paddingBottom:20}}>
                <p>主推寿险起始/一档奖励金额：10000元，当前差距：8000元</p>
                <p>普通寿险起始/一档奖励金额：10000元，当前差距：8000元</p>
                <p>本月累计寿险承保保费排名第10，超过同序列同事30%</p>
            </div>
        );
        const tabPanel = {
            field:"target",
            ...
            defaultShow:"",
            tags:[
                {fieldValue: "",displayValue:"本月统计" },
                {fieldValue: "1",displayValue:"下一个月的规划" },
                {fieldValue: "2",displayValue:"本月总结"}
            ]
        };
