...
import {doRegister} from "../../action/actions"
...
function mapStateToProps(state) {
    return {
        canRegistered:state.canRegistered
    };
}

function mapDispatchToProps(dispatch) {
    return bindActionCreators({ doRegister },dispatch);
}

export const RegisterF = Form.create()(Register);
export const RegisterForm=connect(mapStateToProps,mapDispatchToProps)(RegisterF);
